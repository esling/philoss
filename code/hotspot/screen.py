...
class OLEDSSD1306(Screen):
    ...
    def refresh(
        ...
        self.oled.text("%12s"%type, self.content_x, 10, 1)
        self.oled.text("<" + ip_in, self.content_x, 20, 1)
        self.oled.text(">" + ip_out, self.content_x, 30, 1)
        self.oled.text("v" + values, self.content_x, 40, 1)
