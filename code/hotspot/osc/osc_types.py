...
def get_int64(dgram: bytes, start_index: int):
...
def get_uint64(dgram: bytes, start_index: int):
...
def get_timetag(dgram: bytes, start_index: int):
...
def get_double(dgram: bytes, start_index: int):
...
def get_date(dgram: bytes, start_index: int):
...
def write_date(system_time) -> bytes:
...
def get_rgba(dgram: bytes, start_index: int):
...
def get_midi(dgram: bytes, start_index: int):
